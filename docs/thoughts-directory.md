...
All pipeline artifacts live in `.rpi/`, which is **gitignored by default**. The `.rpi/` directory also contains the codebase index and CLI reference alongside the artifacts:
